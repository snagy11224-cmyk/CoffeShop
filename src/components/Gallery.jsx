...
const items = [
  ...
  { id: 2, type: "Drinks",  label: "Cappuccino", img: "/capuccino.jpg",   price: 90,  desc: "Foamy classic with balance.", sizes: { Small: 0.9, Medium: 1, Large: 1.2 } },
  ...
  { id: 5, type: "Drinks",  label: "Cold Brew",  img: "/cold brew.jpeg",  price: 100, desc: "Slow-steeped, smooth & chilled.", sizes: { Small: 0.9, Medium: 1, Large: 1.25 } },
...
export default function Gallery() {
  ...
  // price inside modal based on chosen size
  ...
  // filter items by tab (includes Favourites)
  ...
  // Heart button (no bootstrap-icons needed)
  const Heart = ({ active }) => (
